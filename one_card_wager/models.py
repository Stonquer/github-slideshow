...
class Player(models.Model):
    ...
    # Screen_Name = models.CharField(max_length=16, primary_key=True, default="Choose a Screen Name")
    # acctNo = models.UUIDField(default=uuid.uuid4, editable=False)
#    onTable = models.ForeignKey('Seat', on_delete=models.SET_NULL, null=True)
...
#    occupant = models.CharField(max_length=20, default=None)
...
class Card(models.Model):
    ...
    #     dex = Deck.unShuffled.index(Card.name) + 1
    #     strdex = str(dex)
